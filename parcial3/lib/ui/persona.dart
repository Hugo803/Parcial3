...
class Persona extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 80, 20, 20),
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          Text('Nacimiento:' + this.personajes.birthyear,
              style: TextStyle(fontSize: 25)),
          Text('Genero:' + this.personajes.gender,
              style: TextStyle(fontSize: 25)),
          Text('Ojos:' + this.personajes.eyecolor,
              style: TextStyle(fontSize: 25)),
          Text('Cabello:' + this.personajes.haircolor,
              style: TextStyle(fontSize: 25)),
          Text('Altura:' + this.personajes.height,
              style: TextStyle(fontSize: 25)),
